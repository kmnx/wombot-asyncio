...
register_exact(
    "id2", ["id2", "idchunt2", "idjukebox", "idchu2"], shazam_handler_for("chunt2")
)
register_exact(
    "idalhara", ["idalhara", "idalh", "idalha", "idalhar"], shazam_handler_for("alhara")
)
register_exact(
    "idshared",
    ["idsha", "idshared", "idsharedfreq", "idsharedfrequencies"],
    shazam_handler_for("sharedfrequencies"),
)
